  ...
  return (
    <div class="supported_chain_container">
      ...
      <div class="flex flex-col gap-8">
        <div class="grid md:grid-cols-3 grid-cols-1 md:gap-4 gap-6 items-center">
          <div class="flex md:justify-end justify-center scale-100 hover:scale-110 transition-all">
            <img src={Binance} alt="Binance" loading="lazy" />
          </div>
          <div class="flex justify-center scale-100 hover:scale-110 transition-all">
            <img
          ...
          <div class="flex md:justify-start justify-center scale-100 hover:scale-110 transition-all">
            <img
              src={Avalanche}
              alt="Avalanche"
              class="w-[242px] h-[46px]"
