...
import styles from "./Privacy.scss?inline";
  ...
  return (
    <div class="privacy_container">
      <div class="content_wrapper">
        <div class="content_wrapper_container">
          <Title title="Privacy Policy" />
          <div class="content">
            <div>Updated at 2022-08-30</div>
            <div>
              Nimbus. ("we," "our," or "us") is committed to protecting your
        ...
        <div class="content_wrapper_container">
          <Title title="Definitions and key terms" />
          <div class="content">
            <div>For this Privacy Policy:</div>
            <ul>
              <li>
                <span>Cookie:</span> small amount of data generated by a website
                and saved by your web browser. It is used to identify your
                browser, provide analytics, remember information about you such
                as your language preference or login information.
              </li>
              <li>
                <span>Company: </span> when this policy mentions “Company,”
                “we,” “us,” or “our,” it refers to Nimbus Inc, Ho Chi Minh, Viet
                Nam that is responsible for your information under this Privacy
                Policy.
              </li>
              <li>
                <span>Country: </span> where Nimbus or the owners/founders of
                Nimbus are based, in this case is Viet Nam.
              </li>
              <li>
                <span>Customer: </span> refers to the company, organization or
                person that signs up to use the Nimbus Service to manage the
                relationships with your consumers or service users.
              </li>
              <li>
                <span>Device: </span>
                any internet connected device such as a phone, tablet, computer
                or any other device that can be used to visit Nimbus and use the
                services.
              </li>
              <li>
              ...
              <li>
                <span>Personal: </span>
                refers to those individuals who are employed by Nimbus or are
              ...
              <li>
                <span>Service: </span>
                refers to the service provided by Nimbus as described in the
              ...
              <li>
                ...
                Nimbus to use the Services.
              </li>
            </ul>
          </div>
        </div>
        <div class="content_wrapper_container">
          <Title title="Information automatically collected" />
          <div class="content">
            ...
            computer and connection information such as browser plug-in types
            and versions and time zone setting, operating systems and platforms,
            purchase history, (we sometimes aggregate with similar information
            from other Users), the full Uniform Resource Locator (URL)
            clickstream to, through and from our Website that may include date
            and time; cookie number; parts of the site you viewed or searched
            for; and the phone number you used to call our Customer Services. We
            may also use browser data such as cookies, Flash cookies (also known
            as Flash Local Shared Objects) or similar data on certain parts of
            our Website for fraud prevention and other purposes. During your
            ...
            technical information to help us identify your device for fraud
            prevention and diagnostic purposes.We automatically collect certain
            information when you visit, use or navigate the platform. This
        ...
        <div class="content_wrapper_container">
          <Title title="How Do We Use The Information We Collect?" />
          <div class="content">
            <div>
        ...
        <div class="content_wrapper_container">
          <Title title="When do we use customer information from third parties?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="Do we share the information we collect with third parties?" />
          <div class="content">
            ...
            successors-in-interest. We may engage trusted third party service
            providers to perform functions and provide services to us, such as
            hosting and maintaining our servers and our service, database
            storage and management, e-mail management, storage marketing, credit
            card processing, customer service and fulfilling orders for products
            ...
            these services for us and for you. We may share portions of our log
            file data, including IP addresses, for analytics purposes with third
            parties such as web analytics partners, application developers, and
            ad networks. If your IP address is shared, it may be used to
            estimate general location and other technographics such as
            connection speed, whether you have visited the service in a shared
            ...
            service and then provide auditing, research and reporting for us and
            ...
            party, the safety of the public or any person, to prevent or stop
            any illegal, unethical, or legally actionable activity, or to
            otherwise comply with applicable court orders, laws, rules and
            regulations.
          </div>
        </div>
        <div class="content_wrapper_container">
          <Title title="Where and when is information collected from customers and end users?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="Could my information be transferred to other countries?" />
          <div class="content">
            We are incorporated in Viet Nam. Information collected via our
        ...
        <div class="content_wrapper_container">
          <Title title="Is the information collected through our service secure?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="Can I update or correct my information?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          ...
          <div class="content">
            ...
            correct your information, (2) change your preferences with respect
        ...
        <div class="content_wrapper_container">
          <Title title="How Long Do We Keep Your Information?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="How Do We Protect Your Information?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          ...
          <div class="content">
            The laws of Viet Nam, excluding its conflicts of law rules, shall
        ...
        <div class="content_wrapper_container">
          <Title title="Links to Other Websites" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="Third-Party Services" />
          <div class="content">
            <div>
        ...
        <div class="content_wrapper_container">
          <Title title="Tracking Technologies" />
          <div class="content">
            <div>Cookies</div>
            <div>
        ...
        <div class="content_wrapper_container">
          <Title title="What is personal data?" />
          <div class="content">
            <div>
        ...
        <div class="content_wrapper_container">
          <Title title="Why is GDPR important?" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          <Title title="Individual Data Subject's Rights - Data Access, Portability and Deletion" />
          <div class="content">
        ...
        <div class="content_wrapper_container">
          ...
          <div class="content">
            ...
            <a href="mailto:contact@getnimbus.io">contact@getnimbus.io</a>
          </div>
        </div>
      </div>
    </div>
